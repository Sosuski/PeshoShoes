...
const Products = () => {
  ...
  const { options, setOption } = useContext(Context);
  ...
  let handleChange = async (e) => {
    ...
    setOption(response1);
    // (options, response1)
    //on every click you gotta send a get request which will give you a response containing the matching product titles using regex
  };
